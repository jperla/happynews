...
def print_topics(beta_file, vocab_file, nwords = 25):
    ...
    # jperla: take out quotes and newlines
    ...
    for topic in file(beta_file, 'r'):
        ...
        # jperla: extend length of topic in case 
        # the documents did not use the whole vocabulary
        topic = topic + ([-100000] * (len(indices) - len(topic)))
